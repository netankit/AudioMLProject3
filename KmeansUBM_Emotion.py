...
It performs the KMeans + GMM Training (Assignment 3 - Semaine Emotion Data for Training)
'''

if len(sys.argv)!=5:
    print '\nUsage: python KmeansUBM_Emotion.py <number_of_gaussians> <Input_speechonly_mfcc_filepath> <kmeans_hdf5_filename> <gmm_hdf5_filename>'
    sys.exit()
...
KMeans_HDF5 = '/mnt/alderaan/mlteam3/Assignment3/data/semaine_emotion_gmm/39D/'+str(kmeans_hdf5_filename).strip()
GMM_HDF5 = '/mnt/alderaan/mlteam3/Assignment3/data/semaine_emotion_gmm/39D/'+str(gmm_hdf5_filename).strip()
