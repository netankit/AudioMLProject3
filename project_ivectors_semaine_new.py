...
if len(sys.argv)!=3:
    print '\nUsage: python project_ivectors_semaine_new.py <number_of_gaussians> <num_folds>'
    sys.exit()
...
if (numfolds == '25'):
    input_emotion_test_features = '/mnt/alderaan/mlteam3/Assignment3/data/Semaine/emotionwise_data_copy/test_multiple_folds/test_multiple_fold25'
if (numfolds == '50'):
    input_emotion_test_features = '/mnt/alderaan/mlteam3/Assignment3/data/Semaine/emotionwise_data_copy/test_multiple_folds/test_multiple_fold50'
if (numfolds == '250'):
    input_emotion_test_features = '/mnt/alderaan/mlteam3/Assignment3/data/Semaine/emotionwise_data_copy/test_multiple_folds/test_multiple_fold250'
    ...
    for root, dir, files in os.walk(input_features):
        for file in files:
            if file.endswith(".dat"):
                ...
                ivectors_path1 = '/mnt/alderaan/mlteam3/Assignment3/data/Semaine/emotionwise_data_copy/test_multiple_folds_ivectors/fold'+str(numfolds)+'/'+ gaussians + '/'
                ivectors_path=os.path.join(ivectors_path1, root_dir_name )
                if not os.path.exists(ivectors_path):
            	   os.makedirs(ivectors_path)
                ivectors_path =	os.path.join(ivectors_path ,str(file.replace(".dat","")) + '_100.ivec')
                #print (ivectors)
